...
async def activate_strategy(strategy_id: str, budget: float):
    try:
        ...
        supabase.table("strategies").update({
            ...
            "deactivated_at": None  # Clear deactivated_at when activating
...
async def startup_event():
    ...
    config = EngineConfig(
        ...
        check_interval=60,
        max_trades_per_strategy=9999999,  # Unlimited trades per strategy
        max_open_trades_total=9999999,  # Unlimited total trades
        risk_per_trade=0.02,
