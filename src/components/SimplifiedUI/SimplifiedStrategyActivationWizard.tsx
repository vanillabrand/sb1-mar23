...
interface SimplifiedStrategyActivationWizardProps {
  strategy: Strategy;
...
export function SimplifiedStrategyActivationWizard({ 
  strategy, 
  onComplete, 
  onCancel,
  maxBudget = 10000
}: SimplifiedStrategyActivationWizardProps) {
  // Wizard state
  ...
  const handleSubmit = async () => {
    try {
      ...
      setIsProcessing(false);
      logService.log('error', 'Failed to activate strategy', error, 'SimplifiedStrategyActivationWizard');
    }
  };
